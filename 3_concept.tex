...
\twocolsframe{Implementation}{
  \begin{itemize}[<+->]
    \item Microsoft HoloLens FOV (~\ang{32}) doesn't cover a handheld phone.
    \item Replicated the AR-Rift \cite{Steptoe2013}, a video pass-through AR HMD.
    \item 
    \begin{itemize}
