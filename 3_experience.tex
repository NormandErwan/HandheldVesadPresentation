...
\twocolsframe{Plan expérimental}{
  ...
  \figurecaption<5-7>{TaskGrid}{Grille de la tâche}
...
\twocolsframe{Résultats}{
  ...
  \figurecaption<4-7>{tct}{Temps de complétion moyen (moyenne arithmétique).}
  \figurecaption<8-9>{tct_ordering}{Temps de complétion moyen par groupe.}
...
\twocolsframe{Résultats}{
  ...
  \figurecaption<2>{selections}{Sélections moyennes de disques}
  \figurecaption<3>{errors}{Erreurs moyennes}
}
