...
\twocolsframe{Résultats}{
  \begin{itemize}[<+->]
    ...
    \begin{itemize}
      \item ANOVA : effets de la technique et du groupe.
      \item Entre les techniques : VESAD tactile < Téléphone < VESAD.
      \item Entre les groupes car courbe d'apprentissage.
    \end{itemize}
  ...
  \only<2>{\figurecaption{tct.png}{Temps de complétion moyen (moyenne arithmétique).}}
  \only<3>{\figurecaption{selections.png}{}}
  \only<4>{\figurecaption{errors.png}{}}
  \only<5>{\figurecaption{preferences_distribution.png}{}}
}