...
\twocolsframe{Conception}{
  ...
  \only<1>{\figurecaption{Fov.png}{Champs de vision}}
  \only<2>{\figurecaption{ArRift_1.jpg}{Notre AR-Rift}}
  \only<3->{\figurecaption{ArRift_2.jpg}{Notre AR-Rift porté}}
}
...
\twocolsframe{Fonctionnement}{
  ...
  \only<1>{\figurecaption{ArRiftMarker_1.jpg}{Image fisheye}}
  \only<2>{\figurecaption{ArRiftMarker_2.jpg}{Image fisheye corrigée}}
  \only<3>{\figurecaption{ArRiftMarker_3.jpg}{Caméra virtuelle filmant la scène et l'image corrigée}}
  \only<4>{\figurecaption{ArRiftMarker_4.jpg}{Résultat dans le visiocasque}}
}
...
\twocolsframe{ArucoUnity}{
  ...
  \only<1>{
    \begin{figure}
      \twocols{\figuregraphic{UnityLogo.png}}{\figuregraphic[0.8]{OpenCvLogo.png}}
      \caption{Logos d'Unity et d'OpenCV}
    \end{figure}
  }
  \only<2>{\figurecaption{OvrvisionTracking_2.jpg}{RA dans notre visiocasque}}
  \only<3>{\figurecaption{OvrvisionCalibration_3.jpg}{Étalonnage de notre camera}}
  \only<4->{
    \begin{figure}
      \twocols{\figuregraphic{TrackMarkersDemo_2.jpg}}{\figuregraphic{TrackMarkersDemo_3.jpg}}
