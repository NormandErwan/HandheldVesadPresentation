...
\twocolsframe{Plan expérimental}{
  ...
  \movie<1>{ExperimentPhoneOnly.jpg}{ExperimentPhoneOnly.swf}{(1) Téléphone}
  \movie<2>{ExperimentPhoneInArOut.jpg}{ExperimentPhoneInArOut.swf}{(2) VESAD tactile}
  \movie<3>{ExperimentMidAirInArOut.jpg}{ExperimentMidAirInArOut.swf}{(3) VESAD}
